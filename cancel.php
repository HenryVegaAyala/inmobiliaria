    ...
    <div id="w">
        <div id="content">
          ...
          <div class="notify successbox">
            <h1>Su cuenta no pudo registrarse</h1>
            <span class="alerticon"><img src="http://s22.postimg.org/i5iji9hv1/check.png" alt="checkmark" /></span>
            <p>Ocurri&oacute; un error al intentar registrarse. Por favor, vuelva a intentarlo.</p>
            <a href="registro.php" class="btn btn-primary btn-large white-text center-block">Volver a registrarse</a>
          </div>
        </div>
    </div>
