    ...
    <div id="w">
        <div id="content">
          ...
          <div class="notify successbox">
            ...
            <p>Muchas gracias por registrarte, en breve se te confirmará tu cuenta para que tengas acceso al sistema CINADSAC.</p>
            <a href="acceso.php" class="btn btn-success btn-large white-text center-block">Acceder</a>
          </div>
        </div>
    </div>
