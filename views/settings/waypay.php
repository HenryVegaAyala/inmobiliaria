...
if ($_POST){
    if (isset($_POST['btnGuardar'])){
        ...
        $rpta = $objData->Registrar($hdIdPrimary, $txtNombre, $txtDescripcion, $txtCodigoSunat, '', '', 0, 0, 0, 0, 0, 0, $idusuario);
...
<form id="form1" name="form1" method="post">
    ...
    <div class="page-region">
        <div id="pnlFormapago" class="inner-page">
...
<script>
    ...
    function MostrarDatos () {
        ...
        .done(function(data) {
            ...
            for (i = 0; i < count; i++) {
                strhtml += '<a href="#" class="list dato" data-id="' + data[i].tm_idformapago + '">';
