...
if ($screenmode == "propietario")
    $rowTipoReporte = $objTabla->ValorPorCampo('ta_tiporeporte_propietario');
else
...
<form id="form1" name="form1" method="post">
    ...
    <div class="page-region">
        <div id="pnlListado" class="inner-page">
            <div class="generic-panel<?php echo ($screenmode == 'propietario' ? '' : ' gp-no-header'); ?> gp-no-footer">
                    ...
                    <div class="row all-height">
                        ...
                        <section class="col-md-10 all-height">
                                ...
                                <div class="generic-panel gp-no-header">
                                    ...
                                    <div class="gp-footer">
                                        <div class="appbar all-height">
                                            <button id="btnGenerarReporte_EXCEL" type="button" class="metro_button float-right" data-hint-position="top" title="Generar reporte en Excel">
                                                <h2><i class="fa fa-file-excel-o" aria-hidden="true"></i></h2>
                                            </button>
                                            <button id="btnGenerarReporte_PDF" type="button" class="metro_button float-right" data-hint-position="top" title="Generar reporte en PDF">
                                                <h2><i class="fa fa-file-pdf-o" aria-hidden="true"></i></h2>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="documentos" class="xpanel all-height">
                                <iframe src="?pag=reports&subpag=archivos&screenmode=<?php echo $screenmode; ?>" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" width="100%" height="100%"></iframe>
                            </div>
                        </section>
                    </div>
                </div>
