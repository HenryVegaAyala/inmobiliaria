$(function() {
    ...
    $("#ddlTipoAfectacion").on("change", function(event) {
        event.preventDefault();
        if ($(this).val() == "01") $(".rowPropietario").addClass("hide"); else $(".rowPropietario").removeClass("hide");
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (countdata > 0) {
                    ...
                    $("#txtSearchConcepto").val(data[0].idconcepto);
                    ...
                    $("#txtSearchProveedor").val(data[0].idproveedor);
                    ...
                    $("#txtFecha").val(data[0].fecha_documento);
                    $("#txtImporte").val(data[0].importe);
                    $("#ddlTipoAfectacion").val(data[0].tipoafectacion);
                    $("#txtSearchPropietario").val(data[0].idpropietario);
                    $("#ddlAnho").val(data[0].tm_per_anho);
...
function EliminarItemGasto(item) {
    var data = new FormData();
    var idgasto = "0";
    idgasto = item.getAttribute("data-idgasto");
